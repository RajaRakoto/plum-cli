...
!((t, _n, e, _i) => {
	...
	(s.prototype = {
		...
		t(e).on("click", (n) => {
			t.each(t("[data-buttons=dropdown]"), function (_e, _i) {
		...
		t(e).on("click", "[data-buttons=dropdown]", (n) => {
			t(n.currentTarget).menuButton();
		}),
		t(e).on("click", "[data-buttons=dropdown] > a", (t) => {
			t.preventDefault();
		});
